...
export default function OrderPage() {
    ...
    const fetchUsers = async () => {
        const { data: response } = await axios.get('http://localhost:8870/api/bill/getallbills');
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers
                                        ...
                                        .map((row) => {
                                            const { id, userId, description, payment, price, createdAt } = row;
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{`${price} ${payment}`}</TableCell>
