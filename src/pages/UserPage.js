                                ...
                                <TableBody>
                                    {filteredUsers
                                        ...
                                        .map((row) => {
                                            ...
                                            const { id, username, roleId, avatar } = row;
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left">{'MeowLearn Vietnam'}</TableCell>
                                                    ...
                                                    <TableCell align="left">
                                                        <Label color={'success'}>{sentenceCase('success')}</Label>
                                                    </TableCell>
